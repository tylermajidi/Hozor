...
<div class="dashboard-main-wrapper">
    ...
    <div class="dashboard-header rtl">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            <a class="navbar-brand " href="/karmand/dashboard">میزکار کارمند</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item rtl text-right ">
                                ...
                                <ul class="nav flex-column">
                                    <li class="nav-item border-right border-3 ">
                                        <a class="nav-link" href="/karmand/dashboard"> <i class="fa fa-fw fa-home m-l-10"></i>پیشخوان</a>
                                    </li>

                                    <li class="nav-item  ">
                                        <a class="nav-link" href="/karmand/PageAddPersenel"> <i class="fas fa-user-plus m-l-10"></i>ثبت پرسنل جدید </a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" href="/karmand/PageListPersenel"><i class="fas fa-users m-l-10"></i>لیست پرسنل</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="/karmand/pagelisthozorgheyab"><i class="fas fa-eye m-l-10"></i>لیست حضور</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="/karmand/PagePadash"><i class="fas fa-eye m-l-10"></i>پاداش و جریمه </a>
                                    </li>
                                </ul>
                            ...
                            <li class="nav-item rtl text-right ">
                                <ul class="nav flex-column">
                                    <li class="nav-item ">
                                        <a class="nav-link" href="/karmand/PageListPersenelHesab"> <i class="fas fa-credit-card m-l-10"></i>پرداخت مساعده</a>
                                    </li>
                                    <li class="nav-item ">
                                        <a class="nav-link" href="/karmand/Pagefish"> <i class="fas fa-clipboard-list m-l-10"></i>فیش حقوقی و ...</a>
                                    </li>

                                    <li class="nav-item ">
                                        <form class="nav-link" method="post" action="/karmand/Pagelisthogogh" >@csrf <button   type="submit" class="border-0 btn-link text-light" href="/karmand/Pagelisthogogh"> <i class="fab fa-apple-pay m-l-10"></i>پرداخت حقوق</button></form>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="/karmand/PageListPay"><i class=" fas fa-list m-l-10"></i>تاریخچه پرداختی ها</a>
                                    </li>
                                    <li class="nav-item ">
                                        <a class="nav-link" href="/karmand/PageCheck"> <i class="fas fa-dollar-sign m-l-10"></i> چک </a>
                                    </li>
                                </ul>
                            </li>
    ...
    function GetSelected() {
        ...
        for (var i = 0; i < checkBoxes.length; i++) {
            if (checkBoxes[i].checked) {
                ...
                jsarray[i] =  row.cells[6].innerHTML;
...
<script>
    ...
    $("#date_check").persianDatepicker({
        cellWidth: 40,
        cellHeight: 28,
        fontSize: 15
    });
    $("#tdate").persianDatepicker({
        cellWidth: 40,
        cellHeight: 28,
        fontSize: 15
    });
...
<script>
    function GenerateTable(){
        var featureTable = document.getElementById("example");
        var tablePopup = window.open("", "", "");
        tablePopup.document.write('<!DOCTYPE html><meta charset="utf-8"> <style type="text/css">#example{direction: rtl;} .table, th, td {border: 1px solid #e6e6f2;padding: 3px;} </style>');
        tablePopup.document.write('<html><head></head><body></body></html>');
    ...
    function GenerateTable2(){
        ...
        var tablePopup = window.open("", "", "");
        tablePopup.document.write('<!DOCTYPE html><meta charset="utf-8"> <style type="text/css">#listperseneltable{direction: rtl;} .table, th, td {border: 1px solid #e6e6f2;padding: 3px;}</style>');
        tablePopup.document.write('<html><head></head><body></body></html>');
        tablePopup.document.write(featureTable.outerHTML);
        tablePopup.document.close();
        map.addControl(sidebar);
