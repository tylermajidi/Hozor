                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <form  class=""  action="/karmand/GetListpayDataFile2" method="Post"> @csrf <input type="hidden" name="sdate" value="{{$datesabt}}"> <input type="hidden" name="mdate" value="{{$date_pay}}"><button type="submit"  class=" btn-brand active"> دریافت تمامی شماره حساب ها </button> </form>
